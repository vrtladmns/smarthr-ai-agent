...
RECRUITER_INTERVIEW_PASS_SCORE = float(os.getenv("RECRUITER_INTERVIEW_PASS_SCORE", "35"))
RECRUITER_INTERVIEW_HOLD_MIN_SCORE = float(os.getenv("RECRUITER_INTERVIEW_HOLD_MIN_SCORE", "25"))
...
ONEDRIVE_RECORDINGS_ENABLED = os.getenv("ONEDRIVE_RECORDINGS_ENABLED", "true").lower() == "true"
ONEDRIVE_RECORDINGS_USER = os.getenv("ONEDRIVE_RECORDINGS_USER", MICROSOFT_MAILBOX)
ONEDRIVE_RECORDINGS_FOLDER = os.getenv("ONEDRIVE_RECORDINGS_FOLDER", "AI Recruiter Interview Recordings")
